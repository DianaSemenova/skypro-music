...
3. Реализация лайка/дизлайка, страницы избранное, перехода между страницами приложения, слушая выбранный плейлист. RTK Query: плановая оценка 30ч/фактически затраченное время 50ч
